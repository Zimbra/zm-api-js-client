		...
		resolvers: {
			...
			Mutation: {
				...
				createAppointment: (_, { accountName, appointment }) =>
					client.createAppointment({ accountName, appointment }),
				createAppointmentException: (_, { accountName, appointment }) =>
					client.createAppointmentException({ accountName, appointment }),
				modifyAppointment: (_, { accountName, appointment }) =>
					client.modifyAppointment({ accountName, appointment }),
